						...
						*/
							...
							positionHoverDivs = function() {
								...
								try {
									if( ! (isChrome || isSafari) ){
										fullScreenBtnOffsetLeft = fullScreenBtnOffsetLeft / zoomRatio;
										fullScreenBtnOffsetTop = fullScreenBtnOffsetTop / zoomRatio;
										fullScreenBtnWidth = fullScreenBtnWidth / zoomRatio;
										fullScreenBtnHeight = fullScreenBtnHeight / zoomRatio;
										containerWidth = containerWidth / zoomRatio;
										containerHeight = containerHeight / zoomRatio;
									}
								} catch(e){}
						...
						t.globalBind('mousemove', function(e) {
							...
							if (fullscreenIsDisabled) {
								...
								try {
									if(  (isChrome || isSafari) ){
										fullscreenBtnPos.top = Math.floor(fullscreenBtnPos.top * zoomRatio);
										fullscreenBtnPos.left = Math.floor(fullscreenBtnPos.left * zoomRatio);
										fullScreenBtnHeight = fullScreenBtnHeight - 33;
									}
								} catch(e){}

								if (e.pageY < fullscreenBtnPos.top || e.pageY > fullscreenBtnPos.top + fullScreenBtnHeight ||
									e.pageX < fullscreenBtnPos.left || e.pageX > fullscreenBtnPos.left + fullscreenBtnWidth
									) {
